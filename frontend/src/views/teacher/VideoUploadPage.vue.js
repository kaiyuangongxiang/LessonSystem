...
import { getTeacherCourseOptions, uploadTeacherVideo } from '@/services/teacher';
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.main, __VLS_intrinsicElements.main)({
    ...{ class: "video-upload-page" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.aside, __VLS_intrinsicElements.aside)({
    ...{ class: "video-upload-sidebar" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-sidebar__eyebrow" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.h1, __VLS_intrinsicElements.h1)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.nav, __VLS_intrinsicElements.nav)({
    ...{ class: "video-upload-nav" },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    type: "button",
    ...{ class: "video-upload-nav__item is-active" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    type: "button",
    ...{ class: "video-upload-nav__item is-disabled" },
    disabled: true,
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.header, __VLS_intrinsicElements.header)({
    ...{ class: "video-upload-head" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-head__eyebrow" },
});
...
if (__VLS_ctx.successMessage) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
        ...{ class: "feedback-text feedback-text--success video-upload-feedback" },
    });
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
    ...{ class: "video-upload-grid" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.article, __VLS_intrinsicElements.article)({
    ...{ class: "video-upload-panel video-upload-panel--form" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-panel__head" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-panel__eyebrow" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.h3, __VLS_intrinsicElements.h3)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
    ...{ onSubmit: (__VLS_ctx.submitVideo) },
    ...{ class: "video-upload-form" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-form__row" },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    value: (__VLS_ctx.form.videoTitle),
    type: "text",
    maxlength: "200",
    placeholder: "请输入视频标题，如《事务与锁机制讲解》",
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({
    ...{ class: "video-upload-field" },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-form__row video-upload-form__row--files" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({
...
(__VLS_ctx.selectedVideo ? __VLS_ctx.selectedVideo.name : '选择主视频文件');
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
(__VLS_ctx.selectedCover ? `文件大小 ${__VLS_ctx.formatFileSize(__VLS_ctx.selectedCover.size)}` : '支持 JPG、PNG、WEBP，建议 16:9 比例');
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "video-upload-dropzone__actions" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
...
/** @type {__VLS_StyleScopedClasses['video-upload-page']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-sidebar']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-sidebar__eyebrow']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-nav']} */ ;
...
/** @type {__VLS_StyleScopedClasses['video-upload-head__eyebrow']} */ ;
...
/** @type {__VLS_StyleScopedClasses['video-upload-feedback']} */ ;
/** @type {__VLS_StyleScopedClasses['course-detail-empty']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-grid']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-panel']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-panel--form']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-panel__head']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-panel__eyebrow']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-form']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-form__row']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-field']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-field']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-field']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-form__row']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-form__row--files']} */ ;
/** @type {__VLS_StyleScopedClasses['video-upload-field']} */ ;
...
/** @type {__VLS_StyleScopedClasses['video-upload-actions']} */ ;
