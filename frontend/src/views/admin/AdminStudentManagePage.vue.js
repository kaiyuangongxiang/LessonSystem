...
import { createAdminStudentUser, deleteAdminStudentUser, getAdminStudentUserList, updateAdminStudentUser, } from '@/services/admin';
...
if (__VLS_ctx.loading) {
...
else if (__VLS_ctx.studentList.length) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.studentList))) {
        ...
        (item.name);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
        (item.profile || '当前尚未填写个人简介，可在编辑中补充学习方向或个人说明。');
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.loading))
                        return;
                    if (!(__VLS_ctx.studentList.length))
                        return;
...
if (__VLS_ctx.editorVisible) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
        value: (__VLS_ctx.editorForm.studentName),
        type: "text",
        maxlength: "50",
        placeholder: "请输入学生姓名",
    });
    ...
    (__VLS_ctx.editingId ? '编辑学生资料时密码可留空，系统会保留原密码。' : '新增学生用户后，可直接用于学生端登录。');
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
